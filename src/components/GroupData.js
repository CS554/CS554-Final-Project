...
function Groups(props) {
  ...
  const { data:userData, refetch:userRefetch } = useQuery(allUsers, {variables: {groupId: props.match.params.id}});
...
const del = (
  <div className = "buttonClass">
  <form onSubmit={handleSubmit2} className={classes2.root} noValidate autoComplete="off">
  <Button
    type="submit"
    value="Submit"
    size="small"
